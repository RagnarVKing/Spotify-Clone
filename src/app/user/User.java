...
public class User {
     ...
     * @param onlineUsers
     */
    public void getOnlineUsers(final List<String> onlineUsers) {
        if (onlineStatus) {
    ...
    public String printCurrentPage() {
        ...
        if (currentPage.equals("homePage")) {
            HomePage homePage = new HomePage(likedSongs, followedPlaylists);
            return homePage.printCurrentPage();
        }
        if (currentPage.equals("likedContentPage")) {
            LikedContentPage likedContentPage =
                    new LikedContentPage(likedSongs, followedPlaylists);
            return likedContentPage.printCurrentPage();
        }

        Artist artist = Admin.getInstance().getArtist(currentPage);
        if (artist != null) {
            ArtistPage artistPage = new ArtistPage(artist.getAlbums(),
                    artist.getMerches(), artist.getEvents());
            return artistPage.printCurrentPage();
        }

        Host host = Admin.getInstance().getHost(currentPage);
        if (host != null) {
    ...
    /**
     * gets a liked song by name
     *
     * @param name
     * @return a song
     */
    public Song getLikedSong(final String name) {
        for (Song song : likedSongs) {
     ...
     * @return the string
     */
    public String changePage(final String name, final String nextPage) {
        if (nextPage.equals("Home")) {
            currentPage = "homePage";
            return name + " accessed " + nextPage + " successfully.";
        }
        if (nextPage.equals("LikedContent")) {
            currentPage = "likedContentPage";
            return name + " accessed " + nextPage + " successfully.";
        }
        return name + " is trying to access a non-existent page.";
    }
